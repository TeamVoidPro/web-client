...
<template>
  <ParkOwnerLayout :park-selector="false">
    <div class="flex flex-col h-full mt-4 mx-4">
      ...
      <div class="flex w-full justify-between h-[300px] gap-8">
        <div class="flex flex-col bg-white rounded-2xl shadow-blue-200 mt-6 px-3 h-[320px] w-1/2">
              ...
              <tr class="text-center" v-for="data in datas">
                ...
                <td>
                  <div class="flex justify-center items-center">
                    <div class="rounded-xl h-fit px-2 py-1 w-[100px]"
                         :class="data.status=='Success'? 'bg-green-200':data.status=='On hold'?'bg-red-200':'bg-blue-200'">
                      {{ data.status }}
                    </div>
                  </div>
                </td>
        ...
        <div class="flex flex-col bg-white rounded-2xl shadow-blue-200 mt-6 px-3 w-1/2 shadow h-[320px]">
